...
- `img/` — `iyon.png`/`ciwul.png`/`couple.png`, placeholder ikon pengguna (lingkaran warna + emoji, 256×256) — **file identik disalin dari `finance/img/`** (bukan digenerate ulang), supaya konsisten visual antar app sampai nanti ditimpa foto asli di kedua tempat.
